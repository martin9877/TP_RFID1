/**
 * @brief libreria wifi . Recomentado por Martin Girardo
 * 
 */
...
/**
 * @brief estados wifi . Recomentado por Martin Girardo
 * 
 */
typedef enum {
	WL_NO_SHIELD = 255,
...
/**
 * @brief modos de encriptacion . Recomentado por Martin Girardo
 * 
 */
