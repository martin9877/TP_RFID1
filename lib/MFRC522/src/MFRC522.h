...
public:
	...
	/**
	 * @brief tamaño FIFO .Recomentado por Martin Girardo
	 * 
	 */
	...
	/**
	 * @brief comandos enviados a PICC . Recomentado por Martin Girardo
	 * 
	 */
	...
	// last value set to 0xff, then compiler uses less ram, it seems some optimisations are triggered
	/**
	 * @brief Retorna codigo de comunicacion Recomentado por Martin Girardo
	 * 
	 */
	...
	/**
	 * @brief Debuging . Recomentado por Martin Girardo
	 * 
	 */
